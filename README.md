...
{{- $serviceSlo := printf "projects/%s/services/%s/serviceLevelObjectives/%s-%s" $.Values.projectId $svc.component $svc.component_$objective.krmName }}
---
    ...
    - displayName: "High Latency Alert - Over 3 seconds"
      conditionThreshold:
        ...
        trigger:
          count: 2
  documentation:
    content: "{{$condition.display_name }}"
